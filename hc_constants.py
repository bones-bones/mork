...
macroList = {
    ...
    "cardsmith": "Don't use mtgcardsmith please, the formatting sucks. Use MagicSetEditor ( https://discord.com/channels/631288872814247966/803384271766683668/1344017056491900950 ), or if you don't want to download something use cardconjurer.app.",
