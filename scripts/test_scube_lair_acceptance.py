...
from cogs.lifecycle.scube_lair_acceptance import (
    ...
    parse_set_id_from_scube_lair_prompt,
)


class ScubeLairAcceptanceTests(unittest.TestCase):
    def test_parses_plain_set_line(self):
        ...
        self.assertEqual(parse_set_id_from_scube_lair_prompt(content), "SCL.X")
    ...
    def test_returns_none_without_set_line(self):
        self.assertIsNone(parse_set_id_from_scube_lair_prompt("No set here"))

    def test_uses_first_line_as_card_name_and_poster_as_author(self):
        card_name, author = card_name_and_author_from_scube_lair_message(
